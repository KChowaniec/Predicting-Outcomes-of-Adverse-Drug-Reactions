"""
File: PrepareDocumentsAllDrugs.py
...
are stored in an 'Outcomes' folder. This script generates documents for all the drugs 
in the file regardless of the drug's suspected role. Once the documents have been generated,
